...
<img src="uploads/<?php echo $row['Image']; ?>" width="50px" height="50px"/></td>


<td align="center"><a href="galleryedit.php?id=<?php echo $row["id"]; ?> ">Edit</a></td>

<td align="center"><a href="gallerydel.php?id=<?php echo $row["id"]; ?> ">DELETE</a></td>
</tr>
<?php $id++; } ?>
</tbody>
</table>
