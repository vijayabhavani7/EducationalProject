...
if ($result->num_rows > 0) {
  ...
  <a class=" fancybox" rel="ligthbox" href="uploads/<?php echo $row['Image']; ?>" >
				
				<img src="uploads/<?php echo $row['Image']; ?>" width="250px" height="200px"/>
</a> 
				<span>
...
if ($result->num_rows > 0) {
  ...
  <a class=" fancybox" rel="ligthbox" href="uploads/<?php echo $row['video']; ?>" >
				
				<iframe src="uploads/<?php echo $row['video']; ?>" width="250px" height="200px"/></iframe>
</a> 
				<span>
