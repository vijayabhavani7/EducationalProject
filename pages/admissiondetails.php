...
<td align="center"><?php echo $row["SSC"]; ?></td>
<td align="center"><?php echo $row["date"]; ?></td>
<td align="center"><?php echo $row["adhar"]; ?></td>
<td align="center"><?php echo $row["gender"]; ?></td>
<td align="center"><?php echo $row["Admission"]; ?></td>
<td align="center"><?php echo $row["mpc"]; ?></td>
<td align="center"><?php echo $row["Bipc"]; ?></td>
...
<td align="center"><?php echo $row["mother"]; ?></td>
<td align="center"><?php echo $row["occupation"]; ?></td>
<td align="center"><?php echo $row["address"]; ?></td>
<td align="center"><a href="delete1.php?id=<?php echo $row["id"]; ?>">DELETE</a></td>
