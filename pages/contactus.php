<?php include("../includes/header.php") ?>
    ...
    <div class="main_wrapper">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-11">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" required="" name="message" cols="10" rows="9"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <!--end row-->
                        ...
                        <div class="sidebar">
                            <div class="list_block sidebar_item">
                                ...
                                <ul class="contact_info">
                                    <li><i class="fa fa-home"></i>Sri Bhavishya Educational Academy</li>
                                    <li><i class="fa fa-envelope"></i><a href="sribhavishya2016@gmail.com">sribhavishya2016@gmail.com</a></li>
                                    <li><i class="fa fa-phone"></i>+91 95813 06060</li>
                                    <li><i class="fa fa-globe"></i><a href="http://www.sribhavishya.com">http://www.sribhavishya.com</a></li>
                                </ul>
                            </div>
        ...
        <div class="contact_map">
            ...
            <iframe src="https://www.google.com/maps/d/embed?mid=1_5Jfa0ZJs9TCkNwA35neDvFyrQw" width="100%" height="280" frameborder="0" style="border: 0" allowfullscreen=""></iframe>
        </div>
    </div>
